                        ...
                        <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-4 xl:grid-cols-4 xl:gap-x-8">
                            <a href='/' className="group">
                                ...
                                <div className="mt-[20px] grid grid-cols-3 gap-4">
                                    <div className="h-5 animate-pulse bg-pink-200 rounded col-span-2"></div>
                                    <div className="h-5 animate-pulse bg-pink-200 rounded col-span-1 float-right"></div>
                                    <div className="h-5 animate-pulse bg-pink-200 rounded col-span-2"></div>
                                </div>
                            </a>
                            <a href='/' className="group">
                                ...
                                <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-4 xl:grid-cols-4 xl:gap-x-8">
                                    {apiData.slice(0, 8).map((data) => (
                                        <a key={data.id} href='/' className="group">
                                            ...
                                            <p className='float-right text-sm'>400+ Orders</p>
...
export function Pagination() {
    return (
        <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
            <div className="mx-auto sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                ...
                <div>
                    <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                        ...
                        >Previous
                            ...
                            {/* <ChevronLeftIcon className="h-5 animate-pulse w-5" aria-hidden="true" /> */}
                        </a>
                        <a
                            href="/products"
                            aria-current="page"
                        ...
                        >Next
                            ...
                            {/* <ChevronRightIcon className="h-5 animate-pulse w-5" aria-hidden="true" /> */}
                        </a>
                    </nav>
                </div>
            </div>
